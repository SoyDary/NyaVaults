...
public class CookiesGUI implements InventoryHolder {	
	...
	public CookiesGUI(String target) throws IOException {	
		this.inv = Bukkit.createInventory(this, 54, plugin.getUtils().color("   &#d9b38c⬤ &#bf8040&lBóveda de galletas &#d9b38c⬤"));
		this.target	= target;
		loadItems(target);	
		}
	...
	public void loadItems(String t) throws IOException {
		...
		String invb64 = pv.getString("CookiesVault.1");
		if(invb64 != null) {
			plugin.getUtils();
	...
	public Inventory getInventory() {		
		...
		inv.setItem(52, plugin.getUtils().vaultItem_cookies(true));
